 ...
 *
 * @brief   gh3x algo call demo code version
 *
 * @version ref gh3x_demo_algo_call_version.h
 *
 */

#ifndef _GH3X_DEMO_ALGO_CALL_VERSION_H_
#define _GH3X_DEMO_ALGO_CALL_VERSION_H_
